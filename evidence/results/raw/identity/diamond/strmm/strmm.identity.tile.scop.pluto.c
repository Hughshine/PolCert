#define S1(zT3,zT4,zT5,$i0,$i1,$i2)	b[$i1][$i2] = b[$i1][$i2] + a[$i0][$i2] * b[$i1][$i0];
...
if (NMAX >= 2) {
  for (t2=0;t2<=floord(NMAX-1,32);t2++) {
    for (t4=0;t4<=floord(NMAX-1,32);t4++) {
      for (t6=0;t6<=min(floord(NMAX-2,32),t2);t6++) {
        for (t7=max(32*t2,32*t6+1);t7<=min(NMAX-1,32*t2+31);t7++) {
