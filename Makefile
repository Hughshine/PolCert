...
POLYGEN=ASTGen.v Canonizer.v CodeGen.v TyTy.v StateTy.v InstrTy.v Loop.v LoopGen.v \
  ...
  LoopCleanup.v LoopSingletonCleanup.v LoopUnroll.v
...
POLCERT_SRC = Base.v Convert.v \
  ...
  TransformContract.v StateView.v ViewPipeline.v StorageWitness.v CellView.v SourceNoAliasWitness.v FramePreservationWitness.v FrameValueWitness.v FramePreservationValidator.v StateObservation.v LayoutWitness.v \
  LayoutRemapValidator.v PrivateStorageWitness.v ScalarExpansionWitness.v ScalarExpansionValueWitness.v PrivateBoundaryWitness.v PaddingLayoutWitness.v LayoutValueWitness.v StorageBoundsWitness.v PaddingLayoutValidator.v PrivateStorageValidator.v CopyProtocolWitness.v CopyCommitWitness.v CopyInstanceWitness.v CopyMappingWitness.v \
  ScalarPromotionWitness.v ScalarPromotionValueWitness.v ScalarPromotionValidator.v ScalarExpansionValidator.v StorageScalarFamilyCompose.v CopyProtocolValueWitness.v CopyProtocolValidator.v ScratchpadCopyValidator.v ReuseConflictWitness.v LifetimeConflictWitness.v ReuseValueWitness.v StorageCompatibilityWitness.v InterArrayReuseWitness.v InterArrayReuseValidator.v ReuseStateView.v StorageBoundaryView.v ReuseConflictValidator.v StorageReuseFamilyCompose.v InstanceProjectionWitness.v InstanceTraceWitness.v \
  InstanceProjectionValidator.v OverlapClosureWitness.v OverlapValueWitness.v OverlapStorageWitness.v OverlapTilingValidator.v VersionCommitWitness.v VersionCommitValueWitness.v VersionReadWitness.v VersionCommitValidator.v \
  ...
  CInstr.v CInstrScalarExpansionWitness.v CInstrScalarExpansionValidatorBridge.v CInstrScalarPromotionWitness.v CInstrScalarPromotionValidatorBridge.v CInstrScalarStorageFamilyCompose.v StoragePrivateFamilyCompose.v StorageCopyFamilyCompose.v StorageOverlapFamilyCompose.v StorageVersionFamilyCompose.v StorageReductionFamilyCompose.v StoragePhaseFamilyCompose.v StorageFrameFamilyCompose.v TInstr.v CTy.v
...
SYNTAX_EXPERIMENT=SInstr.v SPolIRs.v SPolOpt.v SParallelPolOpt.v SLoopUnroll.v STilingOpt.v STilingCanonicalOpt.v STilingBandSched.v SBandTilingOpt.v SInstrSmoke.v
