...
POLYGEN=ASTGen.v Canonizer.v CodeGen.v StateTy.v InstrTy.v Loop.v LoopGen.v \
  ...
  Projection.v Result.v IterSemantics.v PolIRs.v CPolIRs.v TPolIRs.v SPolIRs.v InstanceListSema.v
...
POLCERT_SRC = Base.v Convert.v \
  ...
  CInstr.v TInstr.v SInstr.v TyTy.v CTy.v

# Putting everything together (in driver/)

DRIVER=PolOpt.v CPolOpt.v TPolOpt.v SPolOpt.v TPolValidator.v

SAMPLES=CSample1.v CSample2.v CSample3.v ExtractorSmoke.v SInstrSmoke.v
