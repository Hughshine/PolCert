...
POLCERT_SRC = Base.v Convert.v \
  ...
  CInstr.v CInstrScalarExpansionWitness.v CInstrScalarExpansionValidatorBridge.v CInstrScalarPromotionWitness.v CInstrScalarPromotionValidatorBridge.v CInstrScalarStorageFamilyCompose.v StorageCopyFamilyCompose.v StorageOverlapFamilyCompose.v StorageVersionFamilyCompose.v TInstr.v CTy.v
