...
SYNTAX_EXPERIMENT=SInstr.v SPolIRs.v SPolOpt.v SParallelPolOpt.v STilingOpt.v STilingCanonicalOpt.v STilingBandSched.v SBandTilingOpt.v SInstrSmoke.v
...
.PHONY: proof extraction FORCE materialize-polopt-loop-suite test test-polopt-loop-suite test-polopt-generated test-iss-pluto-suite test-parallel-current-suite test-vector-current-suite test-second-level-tile-suite test-pluto-compat-suite test-end-to-end-c-smoke test-end-to-end-c-perf test-end-to-end-c-matmul-parallel test-end-to-end-generated-smoke test-end-to-end-generated-perf-default test-end-to-end-generated-perf test-end-to-end-generated-heavy test-end-to-end-generated test-end-to-end-generated-perf-parallel test-end-to-end-generated-slow-perf-parallel search-end-to-end-generated-best report-end-to-end-generated-best test-end-to-end-generated-perf-refresh tune-end-to-end-generated test-end-to-end-all test-pluto-bug-matmul-parallel-hint test-diamond-tiling-suite artifact-check artifact-check-full artifact-capability-matrix proof-report profile-advect3d-codegen profile-advect3d-codegen-identity
