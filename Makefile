...
DRIVER=PolOpt.v ParallelPolOpt.v ParallelPolOptCorrect.v PolOptCorrect.v PolOptPrepared.v CPolOpt.v TPolOpt.v TPolValidator.v

SAMPLES=CSample1.v CSample2.v CSample3.v ExtractorSmoke.v

SYNTAX_EXPERIMENT=SInstr.v SPolIRs.v SPolOpt.v SParallelPolOpt.v STilingOpt.v SInstrSmoke.v
