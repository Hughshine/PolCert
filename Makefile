...
POLCERT_SRC = Base.v Convert.v \
  ...
  LayoutRemapValidator.v PrivateStorageWitness.v ScalarExpansionWitness.v PrivateBoundaryWitness.v PaddingLayoutWitness.v LayoutValueWitness.v StorageBoundsWitness.v PaddingLayoutValidator.v PrivateStorageValidator.v CopyProtocolWitness.v CopyCommitWitness.v CopyInstanceWitness.v CopyMappingWitness.v \
