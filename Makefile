...
DRIVER=PolOpt.v PolOptIdentityGenericISS.v PolOptCanonicalTiling.v PolOptBandTiling.v ParallelPolOpt.v ParallelPolOptCorrect.v PolOptCorrect.v VerifiedCompilerConfig.v VerifiedParallelCompilerConfig.v PolOptPrepared.v CPolOpt.v TPolOpt.v TTilingCanonicalOpt.v TPolValidator.v

SAMPLES=CSample1.v CSample2.v CSample3.v ExtractorSmoke.v

SYNTAX_EXPERIMENT=SInstr.v SPolIRs.v SPolOpt.v SParallelPolOpt.v SJamValidator.v SLoopJamValidator.v SLoopJamLower.v SLoopUnroll.v SLoopStride.v SLoopSymbolicSimpl.v STilingOpt.v STilingCanonicalOpt.v STilingBandSched.v SBandTilingOpt.v SVerifiedCompilerConfig.v SVerifiedParallelCompilerConfig.v SInstrSmoke.v
