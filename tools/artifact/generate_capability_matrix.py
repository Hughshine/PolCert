...
SUPPORTED = [
    ...
    Capability("--second-level-tile", "supported", "checked second-level tiling route, including ISS, explicit-current, and Pluto-hinted parallel compositions", "second-level suite; pluto-compat second-level-iss; pluto-compat second-level-parallel; pluto-compat second-level-parallel-matmul-init", "broaden fixtures"),
    ...
    Capability("--diamond-tile", "supported-narrow", "extracted four-phase diamond route with sequential, ISS, second-level, parallel, and multipar compositions", "diamond suite; pluto-compat diamond combinations; Opt_diamond_band_correct", "broaden effect fixtures and polish raw-codegen output cleanup"),
    Capability("--full-diamond-tile", "supported-narrow", "stronger producer mode over the same extracted checked diamond route", "pluto-compat full-diamond; pluto-compat full-diamond-batch; Opt_diamond_band_correct", "add more effect-distinguishing full-diamond cases"),
    ...
    Capability("--diamond-tile --parallel", "supported-narrow", "Pluto supplies the parallel hint; polopt routes the selected dimension through the checked diamond parallel-current validator and retains the checked raw singleton-loop form when cleanup would make traces non-affine", "pluto-compat diamond-parallel; pluto-compat diamond-parallel-jacobi-batch; Opt_parallel_current_diamond_correct", "polish singleton-loop cleanup output"),
