            ...
            "remaining_semantic_gaps": [
                {
                    ...
                    "reason": "The direct Pluto effect corpus now covers the native codegen effects it finds in the default fixture set, but it also records cases where PolOpt applies an additional checked block/jam post-pass while native Pluto's codegen does not visibly change.",
                    "required_work": "If exact policy parity is required, add a non-trusted effect-selection gate that mirrors Pluto's unroll-jam eligibility, while keeping the existing checked LoopUnroll/Jam proof as the correctness gate.",
                },
                {
