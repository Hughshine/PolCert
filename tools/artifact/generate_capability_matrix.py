    ...
    return {
        ...
        "summary": {
            ...
            "remaining_semantic_gaps": [
                {
                    "request": "broader direct-Pluto unroll-jam effect corpus",
                    "reason": "The route now checks each same-bound sibling-loop fusion candidate locally, but the artifact suite still has only focused positive/negative examples instead of a broad corpus comparing direct Pluto C unroll-jam shapes.",
                    "required_work": "Generate more direct-Pluto unroll-jam fixtures, then add strict needles showing which local candidates fuse and which ones correctly fall back.",
                },
                {
