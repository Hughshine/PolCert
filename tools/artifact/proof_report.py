...
TOP_LEVEL_ROUTES = [
    ...
    {
        "route": "checked constant-bound and suffix peel unroll post pass",
        ...
        "theorem_names": ["const_unroll_correct", "suffix_peel_unroll_correct"],
        "note": "This is the checked subset behind Pluto-compatible --unrolljam. Constant-bound loops are fully unrolled; variable-bound loops use a verified suffix cleanup peel plus residual loop.",
    },
    {
