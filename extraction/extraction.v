...
Extract Constant CPolIRs.identity_tiling_phase_scop_scheduler => "Scheduler.run_pluto_identity_tiling_pipeline".
Extract Constant CPolIRs.phase_scop_scheduler_with_iss => "Scheduler.run_pluto_phase_pipeline_with_iss".
Extract Constant CPolIRs.post_tiling_affine_phase_scop_scheduler => "Scheduler.run_pluto_post_tiling_affine_phase_pipeline_nested".
Extract Constant CPolIRs.post_tiling_affine_phase_scop_scheduler_with_iss => "Scheduler.run_pluto_post_tiling_affine_phase_pipeline_with_iss_nested".
...
Extract Constant TPolIRs.identity_tiling_phase_scop_scheduler => "Scheduler.run_pluto_identity_tiling_pipeline".
Extract Constant TPolIRs.phase_scop_scheduler_with_iss => "Scheduler.run_pluto_phase_pipeline_with_iss".
Extract Constant TPolIRs.post_tiling_affine_phase_scop_scheduler => "Scheduler.run_pluto_post_tiling_affine_phase_pipeline_nested".
Extract Constant TPolIRs.post_tiling_affine_phase_scop_scheduler_with_iss => "Scheduler.run_pluto_post_tiling_affine_phase_pipeline_with_iss_nested".
...
Extract Constant SPolIRs.identity_tiling_phase_scop_scheduler => "Scheduler.run_pluto_identity_tiling_pipeline".
Extract Constant SPolIRs.phase_scop_scheduler_with_iss => "Scheduler.run_pluto_phase_pipeline_with_iss".
Extract Constant SPolIRs.post_tiling_affine_phase_scop_scheduler => "Scheduler.run_pluto_post_tiling_affine_phase_pipeline_nested".
Extract Constant SPolIRs.post_tiling_affine_phase_scop_scheduler_with_iss => "Scheduler.run_pluto_post_tiling_affine_phase_pipeline_with_iss_nested".
...
Require Import SLoopJamValidator.
