...
Definition z_not_inb (z: Z) (zs: list Z) : bool :=
  Misc.z_not_inb z zs.

Definition z_nodupb (zs: list Z) : bool :=
  Misc.z_nodupb zs.
...
Proof.
  ...
  pose proof
    (Core.symmetric_second_level_schedule_layout_lex_equivalent
       Core.SecondLevelGrouped
       (List.length before_ctxt) before_pis after_pis bands Hsched)
    as Hlayout.
  eapply
    (Core.second_level_pair_local_reversal_bridge_by_layout_wf_with_env_len
       Core.SecondLevelGrouped
       before_pis before_ctxt before_vars
       after_pis ws bands recipes envv); eauto.
  - intros recipe1 recipe2 Hrecipe1 Hrecipe2.
    rewrite Hsame in Hrecipe1.
    rewrite Hrecipe2 in Hrecipe1.
    inversion Hrecipe1.
    split; reflexivity.
  - intros band1 band2 Hband1 Hband2.
    rewrite Hsame in Hband1.
    rewrite Hband2 in Hband1.
    inversion Hband1.
    reflexivity.
Qed.
...
Proof.
  ...
  eapply
    (Core.ordinary_pair_local_reversal_bridge_by_schedule_len_wf_with_env_len
       before_pis before_ctxt before_vars after_pis ws bands envv
       ipl_ext tau1 tau2); eauto.
  - intros before_pi1 before_pi2 Hbefore1 Hbefore2.
    rewrite Hsame in Hbefore1.
    rewrite Hbefore2 in Hbefore1.
    inversion Hbefore1.
    reflexivity.
  - intros band1 band2 Hband1 Hband2.
    rewrite Hsame in Hband1.
