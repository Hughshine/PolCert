...
Proof.
  ...
  pose proof (instr_point_list_semantics_nil_inv _ _ Htail) as Heq.
  eapply instr_point_sema_stable_under_state_eq with
      (st1 := st1) (st2 := stmid).
  - apply State.eq_refl.
  - exact Heq.
  - exact Hip.
...
Proof.
  ...
  - simpl in Hsem.
    inversion Hsem as [|st1' stmid st3' ip' rest Hip Htail]; subst.
