...
Theorem copy_protocol_declared_bounded_compatible_copyin_values_equal :
  forall (value: Type) input_view output_view expected_commit_targets
         mapping trace value_trace public_cells local_cells
         public_specs local_specs commit_bounds public_bounds local_bounds
...
Proof.
  intros value input_view output_view expected_commit_targets
         ...
         Hcontract Hin.
  destruct Hcontract as [Hbounded _ _ _ _].
  destruct Hbounded as [Hbase _].
  eapply copy_protocol_value_copyin_values_equal; eauto.
Qed.

Theorem copy_protocol_declared_bounded_compatible_copyout_values_equal :
  forall (value: Type) input_view output_view expected_commit_targets
         mapping trace value_trace public_cells local_cells
         public_specs local_specs commit_bounds public_bounds local_bounds
...
Proof.
  ...
  destruct Hcontract as [Hbounded _ _ _ _].
  destruct Hbounded as [Hbase _].
  eapply copy_protocol_value_copyout_values_equal; eauto.
Qed.

Theorem copy_protocol_declared_bounded_compatible_trace_copyin_values_equal :
  forall (value: Type) input_view output_view expected_commit_targets
         mapping trace value_trace public_cells local_cells
         public_specs local_specs commit_bounds public_bounds local_bounds
...
Proof.
  ...
  destruct Hcontract as [Hbounded _ _ _ _].
  destruct Hbounded as [Hbase _].
  eapply copy_protocol_trace_value_copyin_values_equal; eauto.
Qed.

Theorem copy_protocol_declared_bounded_compatible_trace_copyout_values_equal :
  forall (value: Type) input_view output_view expected_commit_targets
         mapping trace value_trace public_cells local_cells
         public_specs local_specs commit_bounds public_bounds local_bounds
...
Proof.
  ...
  destruct Hcontract as [Hbounded _ _ _ _].
  destruct Hbounded as [Hbase _].
  eapply copy_protocol_trace_value_copyout_values_equal; eauto.
Qed.
